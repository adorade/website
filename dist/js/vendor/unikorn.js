/*!
 * UniKorn - Framework for Dreamers - v1.0.0 - unikorn.js
...
if (typeof jQuery === 'undefined') {
  throw new Error('UniKorn\'s JavaScript requires jQuery. jQuery must be included before UniKorn\'s JavaScript.');
}
  ...
  function () {
    ...
    _proto5.hide = function hide(event) {
      ...
      if (transition) {
        ...
        $(this._element).one(Util.TRANSITION_END, function (event) {
          return _this10._hideDrawer(event);
        }).emulateTransitionEnd(transitionDuration);
      } else {
        this._hideDrawer();
      }
    ...
    _proto5._enforceFocus = function _enforceFocus() {
      ...
      .on(Event.FOCUSIN, function (event) {
        if (document !== event.target && _this12._element !== event.target && $(_this12._element).has(event.target).length === 0) {
    ...
    Drawer._jQueryInterface = function _jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        ...
        var _config = _objectSpread({}, Drawer.Default, $(this).data(), typeof config === 'object' && config);
    ...
    _proto6._getPopperConfig = function _getPopperConfig() {
      ...
      if (typeof this._config.offset === 'function') {
        offsetConf.fn = function (data) {
          data.offsets = _objectSpread({}, data.offsets, _this20._config.offset(data.offsets) || {});
          return data;
        };
      } else {
...
var Modal = function ($) {
  ...
  function () {
    ...
    _proto7.show = function show(relatedTarget) {
      ...
      $(this._element).on(Event.CLICK_DISMISS, Selector.DATA_DISMISS, function (event) {
        return _this21.hide(event);
      });
      $(this._dialog).on(Event.MOUSEDOWN_DISMISS, function () {
        $(_this21._element).one(Event.MOUSEUP_DISMISS, function (event) {
          if ($(event.target).is(_this21._element)) {
            _this21._ignoreBackdropClick = true;
          }
        });
      });

      this._showBackdrop(function () {
        return _this21._showElement(relatedTarget);
      });
    };
    ...
    _proto7.hide = function hide(event) {
      ...
      if (transition) {
        var transitionDuration = Util.getTransitionDurationFromElement(this._element);
        $(this._element).one(Util.TRANSITION_END, function (event) {
          return _this22._hideModal(event);
        }).emulateTransitionEnd(transitionDuration);
      } else {
        this._hideModal();
      }
    ...
    _proto7._enforceFocus = function _enforceFocus() {
      ...
      $(document).off(Event.FOCUSIN) // guard against infinite focus loop
      .on(Event.FOCUSIN, function (event) {
        if (document !== event.target && _this24._element !== event.target && $(_this24._element).has(event.target).length === 0) {
    ...
    _proto7._setResizeEvent = function _setResizeEvent() {
      ...
      if (this._isShown) {
        $(window).on(Event.RESIZE, function (event) {
          return _this26.handleUpdate(event);
        });
      } else {
        $(window).off(Event.RESIZE);
      }
    ...
    _proto7._hideModal = function _hideModal() {
      ...
      this._showBackdrop(function () {
        ...
        _this27._resetAdjustments();

        _this27._resetScrollbar();

        $(_this27._element).trigger(Event.HIDDEN);
      });
    };
    ...
    _proto7._showBackdrop = function _showBackdrop(callback) {
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        $(this._backdrop).appendTo(document.body);
        $(this._element).on(Event.CLICK_DISMISS, function (event) {
          if (_this28._ignoreBackdropClick) {
            _this28._ignoreBackdropClick = false;
            return;
          }
          ...
          if (_this28._config.backdrop === 'static') {
            _this28._element.focus();
          } else {
            _this28.hide();
          }
        });
    ...
    _proto7._setScrollbar = function _setScrollbar() {
      ...
      if (this._isBodyOverflowing) {
        ...
        $(Selector.FIXED_CONTENT).each(function (index, element) {
          var actualPadding = $(element)[0].style.paddingRight;
          var calculatedPadding = $(element).css('padding-right');
          $(element).data('padding-right', actualPadding).css('padding-right', parseFloat(calculatedPadding) + _this29._scrollbarWidth + "px");
        }); // Adjust sticky content margin

        $(Selector.STICKY_CONTENT).each(function (index, element) {
          var actualMargin = $(element)[0].style.marginRight;
          var calculatedMargin = $(element).css('margin-right');
          $(element).data('margin-right', actualMargin).css('margin-right', parseFloat(calculatedMargin) - _this29._scrollbarWidth + "px");
        }); // Adjust navbar-toggler margin
...
var ScrollSpy = function ($) {
  ...
  function () {
    ...
    var _proto8 = ScrollSpy.prototype;

    _proto8.refresh = function refresh() {
      var _this32 = this;
      ...
      targets.map(function (element) {
        ...
        _this32._offsets.push(item[0]);

        _this32._targets.push(item[1]);
      });
    };
    ...
    _proto8._getScrollTop = function _getScrollTop() {
      return this._scrollElement === window ? this._scrollElement.pageYOffset : this._scrollElement.scrollTop;
    };

    _proto8._getScrollHeight = function _getScrollHeight() {
      return this._scrollElement.scrollHeight || Math.max(document.body.scrollHeight, document.documentElement.scrollHeight);
    };

    _proto8._getOffsetHeight = function _getOffsetHeight() {
      return this._scrollElement === window ? window.innerHeight : this._scrollElement.getBoundingClientRect().height;
    };

    _proto8._process = function _process() {
    ...
    _proto8._activate = function _activate(target) {
    ...
    _proto8._clear = function _clear() {
...
var Tab = function ($) {
  ...
  function () {
    ...
    _proto9.show = function show() {
      ...
      var complete = function complete() {
        var hiddenEvent = $.Event(Event.HIDDEN, {
          relatedTarget: _this33._element
        });
        var shownEvent = $.Event(Event.SHOWN, {
          relatedTarget: previous
        });
        $(previous).trigger(hiddenEvent);
        $(_this33._element).trigger(shownEvent);
      };
    ...
    _proto9._activate = function _activate(element, container, callback) {
      var _this34 = this;
      ...
      var complete = function complete() {
        return _this34._transitionComplete(element, active, callback);
      };
    ...
    _proto9._transitionComplete = function _transitionComplete(element, active, callback) {
      if (active) {
...
var Tooltip = function ($) {
  ...
  function () {
    ...
    var _proto10 = Tooltip.prototype;

    _proto10.enable = function enable() {
      this._isEnabled = true;
    };

    _proto10.disable = function disable() {
      this._isEnabled = false;
    };

    _proto10.toggleEnabled = function toggleEnabled() {
      this._isEnabled = !this._isEnabled;
    };

    _proto10.toggle = function toggle(event) {
      if (!this._isEnabled) {
        return;
      }
    ...
    _proto10.show = function show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        this._popper = new Popper(this.element, tip, {
          ...
          onCreate: function onCreate(data) {
            if (data.originalPlacement !== data.placement) {
              _this35._handlePopperPlacementChange(data);
            }
          },
        ...
        var complete = function complete() {
          if (_this35.config.animation) {
            _this35._fixTransition();
          }

          var prevHoverState = _this35._hoverState;
          _this35._hoverState = null;
          $(_this35.element).trigger(_this35.constructor.Event.SHOWN);
    ...
    _proto10.hide = function hide(callback) {
      var _this36 = this;
      ...
      var complete = function complete() {
        if (_this36._hoverState !== HoverState.SHOW && tip.parentNode) {
          tip.parentNode.removeChild(tip);
        }

        _this36._cleanTipClass();

        _this36.element.removeAttribute('aria-describedby');

        $(_this36.element).trigger(_this36.constructor.Event.HIDDEN);

        if (_this36._popper !== null) {
    ...
    _proto10.update = function update() {
      if (this._popper !== null) {
        this._popper.scheduleUpdate();
      }
    }; // protected
    ...
    _proto10.isWithContent = function isWithContent() {
      return Boolean(this.getTitle());
    };

    _proto10.addAttachmentClass = function addAttachmentClass(attachment) {
      $(this.getTipElement()).addClass(CLASS_PREFIX + "-" + attachment);
    };

    _proto10.getTipElement = function getTipElement() {
      this.tip = this.tip || $(this.config.template)[0];
      return this.tip;
    };

    _proto10.setContent = function setContent() {
      var $tip = $(this.getTipElement());
      this.setElementContent($tip.find(Selector.TOOLTIP_INNER), this.getTitle());
      $tip.removeClass(ClassName.FADE + " " + ClassName.SHOW);
    };

    _proto10.setElementContent = function setElementContent($element, content) {
    ...
    _proto10._getAttachment = function _getAttachment(placement) {
      return AttachmentMap[placement.toUpperCase()];
    };

    _proto10._setListeners = function _setListeners() {
      var _this37 = this;

      var triggers = this.config.trigger.split(' ');
      triggers.forEach(function (trigger) {
        if (trigger === 'click') {
          $(_this37.element).on(_this37.constructor.Event.CLICK, _this37.config.selector, function (event) {
            return _this37.toggle(event);
          });
        } else if (trigger !== Trigger.MANUAL) {
          var eventIn = trigger === Trigger.HOVER ? _this37.constructor.Event.MOUSEENTER : _this37.constructor.Event.FOCUSIN;
          var eventOut = trigger === Trigger.HOVER ? _this37.constructor.Event.MOUSELEAVE : _this37.constructor.Event.FOCUSOUT;
          $(_this37.element).on(eventIn, _this37.config.selector, function (event) {
            return _this37._enter(event);
          }).on(eventOut, _this37.config.selector, function (event) {
            return _this37._leave(event);
          });
        }

        $(_this37.element).closest('.modal').on('hide.bs.modal', function () {
          return _this37.hide();
        });
      });
    ...
    _proto10._fixTitle = function _fixTitle() {
    ...
    _proto10._enter = function _enter(event, context) {
      var dataKey = this.constructor.DATA_KEY;
    ...
    _proto10._leave = function _leave(event, context) {
      var dataKey = this.constructor.DATA_KEY;
      context = context || $(event.currentTarget).data(dataKey);
    ...
    _proto10._isWithActiveTrigger = function _isWithActiveTrigger() {
    ...
    _proto10._getDelegateConfig = function _getDelegateConfig() {
      var config = {};
    ...
    _proto10._cleanTipClass = function _cleanTipClass() {
      var $tip = $(this.getTipElement());
    ...
    _proto10._handlePopperPlacementChange = function _handlePopperPlacementChange(data) {
      this._cleanTipClass();

      this.addAttachmentClass(this._getAttachment(data.placement));
    };

    _proto10._fixTransition = function _fixTransition() {
      var tip = this.getTipElement();
...
var Popover = function ($) {
  ...
  function (_Tooltip) {
    ...
    var _proto11 = Popover.prototype;

    // overrides
    _proto11.isWithContent = function isWithContent() {
      return this.getTitle() || this._getContent();
    };

    _proto11.addAttachmentClass = function addAttachmentClass(attachment) {
      $(this.getTipElement()).addClass(CLASS_PREFIX + "-" + attachment);
    };

    _proto11.getTipElement = function getTipElement() {
      this.tip = this.tip || $(this.config.template)[0];
      return this.tip;
    };

    _proto11.setContent = function setContent() {
    ...
    _proto11._getContent = function _getContent() {
      return this.element.getAttribute('data-content') || this.config.content;
    };

    _proto11._cleanTipClass = function _cleanTipClass() {
      var $tip = $(this.getTipElement());
      var tabClass = $tip.attr('class').match(BSCLS_PREFIX_REGEX);
...
//# sourceMappingURL=maps/unikorn.js.map
